...
SF_list as (
 ...
 NpiIds as (
   select NPI, MONOLITH_PROFESSIONAL_ID, PRACTICE_NAME
   from "CISTERN"."PROVIDER"."PROVIDER" NpiTable
  ),
...
select distinct fl.C_Docter_ID,
     ...
     //  sl.MARKET__C,
       ...
       JOIN NpiIds ON fl.Docter_ID = MONOLITH_PROFESSIONAL_ID
)
